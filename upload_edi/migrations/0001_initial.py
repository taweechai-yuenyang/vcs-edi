    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('0', 'Draff'), ('1', 'In Process'), ('2', 'Success'), ('3', 'Failure')], default='0', max_length=1, verbose_name='Order Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='PRIMARY KEY')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('request_status', models.CharField(choices=[('0', 'Draff'), ('1', 'Approve'), ('2', 'Reject'), ('3', 'Failure')], default='0', max_length=1, verbose_name='Request Status')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('request_by_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Request By ID')),
                ('request_order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='upload_edi.requestorder', verbose_name='Request ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='PRIMARY KEY')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('purchase_request_status', models.CharField(choices=[('0', 'Draff'), ('1', 'Approve'), ('2', 'Reject'), ('3', 'Failure')], default='0', max_length=1, verbose_name='Purchase Request Status')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='PRIMARY KEY')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('purchase_request_status', models.CharField(choices=[('0', 'Draff'), ('1', 'Approve'), ('2', 'Reject'), ('3', 'Failure')], default='0', max_length=1, verbose_name='Purchase Order Status')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('approve_by_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Approve By ID')),
