    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ro_status', models.CharField(choices=[('0', 'Draff'), ('1', 'In Process'), ('2', 'Success')], default='0', max_length=1, verbose_name='Request Status')),
                ('is_sync', models.BooleanField(default=False, verbose_name='Is Sync')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_status', models.CharField(choices=[('0', 'Draff'), ('1', 'In Process'), ('2', 'Success')], default='0', max_length=1, verbose_name='Request Status')),
