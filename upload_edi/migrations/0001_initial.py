    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_no', models.CharField(blank=True, max_length=150, null=True, verbose_name='Document No.')),
                ...
                ('upload_by_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Upload By ID')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('edi_file_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='upload_edi.uploadedi', verbose_name='EDI File ID')),
