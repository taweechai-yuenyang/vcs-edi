...
class OrderH(models.Model):
    ...
    FCSKID = models.CharField(max_length=8, db_column="FCSKID", default=nanoid.generate(size=8), blank=True, null=True)
    FCLUPDAPP = models.CharField(max_length=2, db_column="FCLUPDAPP")
    ...
    FNVATRATE = models.FloatField(db_column="FNVATRATE", default="0.0", blank=True, null=True)
...
class OrderI(models.Model):
    ...
    FCSHOWCOMP = models.CharField(max_length=1, db_column="FCSHOWCOMP")
    FCSKID = models.CharField(max_length=8, db_column="FCSKID", default=nanoid.generate(size=8), blank=True, null=True)
...
class NoteCut(models.Model):
    ...
    FCSKID = models.CharField(max_length=8, db_column="FCSKID", blank=True, null=True, default=nanoid.generate(size=8))
